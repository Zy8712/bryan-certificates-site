    ...
    return (
        <>
            {credentialData.map((image, index) => (
                <div className="w-[425px] h-36 flex justify-between bg-gradient-to-b from-light-gray to-very-dark-blue rounded-md overflow-hidden cursor-pointer hover:scale-110 transition-all duration-500 ease-in-out">
                    <img
                        key={index}
